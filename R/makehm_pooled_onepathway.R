...
#' and filters to a single signaling pathway of interest.
#'
...
#' @param pathway A character string specifying the pathway name to visualize.
...
#' @export
makehm_pooled_onepathway <- function(all_objects_list, col_fun, sources, targets, 
                                     fontsize, pathway, hmtitle) {
  ...
  df.netPx1outgoing <- df.netPx1outgoing[df.netPx1outgoing$pathway_name == pathway, ]
